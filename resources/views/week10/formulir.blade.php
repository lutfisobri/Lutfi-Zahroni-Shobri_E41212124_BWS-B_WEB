                    ...
                    <div class="col-lg-auto">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Hello World!</h1>
                            </div>
                            <form class="user" method="POST" action="{{ route('week10.request.proses') }}">
                                @csrf
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="nama"
                                        name="nama" aria-describedby="emailHelp" placeholder="Masukkan nama" required
                                        value="{{ old('nama') }}">
                                    @if ($errors->has('nama'))
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="alamat" required
