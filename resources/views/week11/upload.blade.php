            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                    <div class="col-lg-auto">
                        <form action="{{ route('week11.image.upload') }}" method="post" class="mt-2" enctype="multipart/form-data">
                            @csrf

                            <div class="form-group">
                                <input type="file" class="form-control form-control-user" id="image"
                                    name="image" aria-describedby="image" placeholder="Masukkan file" required
                                    value="{{ old('image') }}">
                                @if ($errors->has('image'))
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="description"
                                    name="description" aria-describedby="emailHelp" placeholder="Masukkan Deskripsi"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3 mt-2">
                                    <input type="submit" value="Simpan"
                                        class="btn btn-primary btn-user btn-bloc items-centerk">
                                </div>
                                @if (session('status'))
