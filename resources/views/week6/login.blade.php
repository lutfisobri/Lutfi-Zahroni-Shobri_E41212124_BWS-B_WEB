                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="{{ route('week6.login') }}">
                                        @csrf
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="username" name="username"
                                                aria-describedby="emailHelp" placeholder="Enter Username/Email" value="{{ old('username') }}">
                                        </div>
                                        <div class="form-group">
